...
<a href="<?php echo $base_url; ?>profil/sunting/" class="btn btn-default">Sunting data profil</a>
<a id="modal" href="#modal-container" data-toggle="modal" class="btn btn-danger">Batalkan pendaftaran</a>
			...
			<div class="modal fade" id="modal-container" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						Jika anda membatalkan pendaftaran, semua data anda akan dihapus dari sistem dan anda otomatis didiskualifikasi. <br><br>Jika ingin kembali mendaftar, Anda dapat mencoba lagi di halaman Pendaftaran.
						
						</div>
						<div class="modal-footer">
							
							 <input type="button" class="btn btn-default" value="Kembali" data-dismiss="modal"><a href="<?php echo $base_url; ?>profil/batal/" class="btn btn-danger">Batalkan pendaftaran</a>
							</form>
						</div>
					</div>
